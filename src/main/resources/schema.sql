...
ALTER TABLE USER_RELATIONSHIPS ADD FOREIGN KEY (FOLLOWER_ID) REFERENCES USER(USER_ID);
ALTER TABLE USER_RELATIONSHIPS ADD FOREIGN KEY (FOLLOWED_ID) REFERENCES USER(USER_ID);
